...
public class MltReasoner {
	...
	//OK //∀x iof(x,Individual)↔∄y iof(y,x) (A1)
	//INF //∀t iof(t,1stOT)↔(∀x iof(x,t)→iof(x,Individual)) (A2)
	//INF //∀t iof(t,2ndOT)↔(∀t′ iof(t′,t)→iof(t′,1stOT)) (A3)
	//INF //∀t iof(t,3rdOT)↔(∀t′ iof(t′,t)→iof(t′,2ndOT)) (A4)
	//e se o cara estiver falando de 4thOT? //∀x (iof(x,Individual)∨iof(x,1stOT)∨iof(x,2ndOT)∨iof(x,3rdOT))∨(x=3rdOT) (A5)
	//OWL //∄x (iof(x,Individual)∧iof(x,1stOT))∨(iof(x,Individual)∧iof(x,2ndOT))∨ (iof(x,Individual)∧iof(x,3rdOT))∨(iof(x,1stOT)∧iof(x,2ndOT))∨(iof(x,1stOT)∧iof(x,3rdOT))∨(iof(x,2ndOT)∧iof(x,3rdOT)) (A6)
	//complicado em mundo aberto //∀t1,t2 (¬iof(t1,Individual)∧¬iof(t2,Individual))→((t1=t2)↔(∀e iof(e,t1)↔iof(e,t2))) (A7)
	//OWL //∀t1,t2 specializes(t1,t2)↔(¬iof(t1,Individual)∧¬iof(t2,Individual)∧(∀e iof(e,t1)→iof(e,t2))) (A8)
	//não faremos? //∀ t1,t2 properSpecializes(t1,t2)↔(specializes(t1,t2)∧t1≠t2) (A9)
	...
	//OWL //iof(Individual, 1stOT) (T1)
	//OWL //iof(1stOT, 2ndOT) (T2)
	//OWL //iof(2ndOT, 3rdOT) (T3)
	//só para os diretamente ligados? //∀t iof(t,1stOT)↔specializes(t,Individual) (T4)
	//só para os diretamente ligados?  //∀t iof(t,2ndOT)↔specializes(t,1stOT) (T5)
	//só para os diretamente ligados?  //∀t iof(t,3rdOT)↔specializes(t,2ndOT) (T6)
